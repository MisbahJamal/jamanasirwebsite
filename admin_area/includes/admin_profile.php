...
<?php 
    ...
    if(isset($_GET['admin_profile'])){
        ...
        $user_about = $row_user['About'];
        
        $user_contact = $row_user['Contact'];
        
        $user_job = $row_user['Job'];
...
if(isset($_POST['update'])){
    ...
    $update_user = "update admins set Name='$user_name',Email='$user_email',Password='$user_pass',Country='$user_country',Contact='$user_contact',Job='$user_job',About='$user_about',Image='$user_image' where admin_id='$user_id'";
