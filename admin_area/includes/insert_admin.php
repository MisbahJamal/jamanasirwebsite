...
if(isset($_POST['submit'])){
    ...
    $insert_user = "insert into admins (Name,Email,Password,Country,Contact,Job,Image,About) values ('$user_name','$user_email','$user_pass','$user_country','$user_contact','$user_job','$user_image','$user_about')";
    ...
    if($run_user){
        ...
        echo "<script>alert('Server was unable to add new admin.Try Again')</script>";
    }
