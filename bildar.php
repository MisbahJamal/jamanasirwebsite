...
<html lang="en">
  ...
  <nav  class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar" style="border-bottom: white 1px solid;">
	    <div class="container" >
	      <a class="navbar-brand" href="index.html"><span>WSSCI</span></a>
        ...
        <div class="container">
          <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-start" data-scrollax-parent="true">
              <div class="col-md-8 ftco-animate mt-5" data-scrollax=" properties: { translateX: '70%' }" style="font-family: 'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif;">
                  ...
                  <h1 class="mb-4 text-right" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }" style="font-weight: bold;font-family: ;"> About Bildaars</h1>
                  <p class="mb-4 text-right" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }" style="font-weight: 50;">Below is the list of Bildaars</p>
                </div>
          </div>
        </div>
      </section>
...
<!-- table end -->
    ...
    <footer class="ftco-footer ftco-section" style="padding: 10px 0 0 0;">
        ...
        <div class="col-md-12 text-center">
         <p>
            Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved @TeamJamal Sol
         </p>
        </div>
        </div>
