        ...
        <div class="container">
          <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-start" data-scrollax-parent="true">
              <div class="col-md-8 ftco-animate mt-5" data-scrollax=" properties: { translateX: '70%' }" style="font-family: 'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif;">
                  ...
                  <h1 class="mb-4 text-right" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }" style="font-weight: bold;font-family: ;">Containers Details</h1>
                  <p class="mb-4 text-right" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }" style="font-weight: 50;">Below is the list of containers in concerened Councels</p>
                </div>
          </div>
        </div>
      </section>
...
<table class="table table-striped " style="color: black;width: 90%; border: 1px black solid; margin-top: 40px;">
    ...
    <?php 
                   ...
                   $container_query_result = run_query($get_container);
                   
                   while($container=mysqli_fetch_array($container_query_result)){
                       $cont_id = $container['cont_id']
                    ?>
                       <tr>
        <th scope="row"><?php echo $container['cont_id']; ?></th>
        <td><?php echo $container['cont_name']; ?></td>
        <td><?php echo $container['cont_location']; ?></td>
        <td><?php echo $container['cont_status']; ?></td>
        <td><?php echo '<a href="containerprofile.php?cont_id=' . $cont_id . '"><button class="btn btn-dark">View Details</button></a>'; ?> </td>
